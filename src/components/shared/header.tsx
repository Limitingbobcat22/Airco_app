          ...
          <li className="min-w-0 truncate">
            {isAdminAircos || legalTitle ? (
              ...
              <button
                ...
                className="cursor-pointer truncate transition hover:text-ink/70 focus-visible:rounded-md focus-visible:ring-2 focus-visible:ring-mint focus-visible:outline-none"
              >
                {topicLabel}
              </button>
            )}
