...
export default function SavingsPanel({
  ...
  if (!airco || !savings) {
    return (
      ...
      >
        <div className="relative rounded-3xl border border-dashed border-teal/30 bg-white p-8 text-center text-ink/60">
      ...
      <div className="relative mt-8 grid gap-4 lg:grid-cols-3">
        ...
        <div className="rounded-3xl bg-deep p-5 text-white sm:p-6">
          ...
          <dl className="mt-5 space-y-3 text-sm text-white/75">
            <div className="flex justify-between gap-3">
              <dt>Model</dt>
              <dd className="font-medium text-white">{airco.model}</dd>
            </div>
            <div className="flex justify-between gap-3">
              <dt>Koel vermogen</dt>
